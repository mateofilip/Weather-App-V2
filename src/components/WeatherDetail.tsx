...
export default function WeatherDetail({
  ...
  return (
    ...
    >
      <div
        className="relative flex h-[85vh] w-[85vw] flex-col place-items-center rounded-2xl bg-white px-3 py-5 dark:bg-slate-700"
      ...
      >
        ...
        <div className="flex h-1/2 flex-col place-items-center justify-center gap-3 text-center">
          <img
        ...
        <div className="grid h-1/2 w-full grid-cols-2 grid-rows-3 place-items-center gap-2">
          <section className="grid h-full w-full content-between rounded-2xl bg-slate-100 p-3 opacity-85 dark:bg-slate-800">
